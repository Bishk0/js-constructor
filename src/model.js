import image from './assets/tumblr_ph7j2aNzQe1s49f4m_1280.jpg'
import {TextBlock, TitleBlock, ImageBlock, ColumnBlock} from './classes/blocks'
...
export const model = [
    ...
    new ImageBlock(image, {
        ...
        alt: 'my image',
        imageStyles: 'width: 500px; height: 300px;'
    }),
    new ColumnBlock([
